...
def add_user(id):  # Take int or str with numbers only , Returns Boolean
    ...
    try:
        ...
        print(f"King-Userbot LOG : // functions/pmbot/add_user : {e}")
        return False
...
def del_user(id):  # Take int or str with numbers only , Returns Boolean
    ...
    try:
        ...
        print(f"King-Userbot LOG : // functions/pmbot/del_user : {e}")
        return False
...
def blacklist_user(id):  # Take int or str with numbers only , Returns Boolean
    ...
    try:
        ...
        print(f"King-Userbot LOG : // functions/pmbot/blacklist_user : {e}")
        return False
...
def rem_blacklist(id):  # Take int or str with numbers only , Returns Boolean
    ...
    try:
        ...
        print(f"King-Userbot LOG : // functions/pmbot/rem_blacklist : {e}")
        return False
