...
from plugins import *
from pyking.misc._decorators import *
from pyking.misc._wrappers import *
from ..__main__ import asst
from ..dB.core import *
from ..dB.database import Var
from ..functions.sudos import *

ALIVE_NAME = king_bot.me.first_name
...
def sudo_cmd(allow_sudo=True, pattern=None, **args):
    args["func"] = lambda e: e.via_bot_id is None
    stack = inspect.stack()
    previous_stack_frame = stack[1]
    file_test = Path(previous_stack_frame.filename)
...
#   KingBot Don't Need This Configs
